 ...
 */
final class Version20240115142317 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article DROP slug, DROP published');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article ADD slug VARCHAR(255) NOT NULL, ADD published TINYINT(1) NOT NULL');
    }
}
